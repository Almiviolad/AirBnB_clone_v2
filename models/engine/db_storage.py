...
class DBStorage:
    ...
    def all(self, cls=None):
        """queries all ibjs associated with cls"""
        if cls:
    ...
    def save(self):
        """Commits changes on current sessiin
    """
    ...
    def reload(self):
        """Create the current database session (self.__session) fromthe engine (self.__engine) by using a sessionmaker
    """
        from models.user import User
        from models.state import State
        from models.city import City
